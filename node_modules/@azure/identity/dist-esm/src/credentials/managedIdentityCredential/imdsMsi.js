...
export const imdsMsi = {
    ...
    async getToken(configuration, getTokenOptions = {}) {
        ...
        for (let retries = 0; retries < imdsMsiRetryConfig.maxRetries; retries++) {
            try {
                const request = createPipelineRequest(Object.assign(Object.assign({ abortSignal: getTokenOptions.abortSignal }, prepareRequestOptions(scopes, clientId)), { allowInsecureConnection: true }));
